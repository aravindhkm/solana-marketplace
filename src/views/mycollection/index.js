        ...
        <section className="innerPagescnt">
        	<Container>
	        	<Row className="justify-content-center">
	        		<Col lg="12">
	        			<h3 className="secTitle">My Collections</h3>
	        		</Col>
	        		<Col lg="6">
	        			<p className="secSubheading">Create, curate, and manage collections of unique NFTs to share and sell.</p>
	        		</Col>
	        		<Col lg="12" className="d-flex justify-content-center">
	        			<button className="btn gradientBtn">Create a Collection</button>
	        		</Col>
	        	</Row>
